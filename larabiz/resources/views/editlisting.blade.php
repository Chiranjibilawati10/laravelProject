...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">Edit Listing <a class="btn btn-default btn-xs" href="/dashboard">Go Back</a></div>
            ...
            <div class="card-body">
            	{!! Form::open(['action' => ['ListingsController@update',$listing->id], 'method' => 'POST']) !!}
    				...
    				{{Form::bsText('phone', $listing->phone, ['placeholder' => 'Contact Person'])}}
